...
class MSCustomTax
{
    ...
    public function registerTaxonomy()
    {
        ...
        // Trial Age
        $tax_array["trial_age"] = self::taxonomyArray("Trial Age", "Trial Ages", 'trial-age');

        $tax_array["trial_language"] = self::taxonomyArray("Trial Language", "Trial Languages", 'trial-language');
